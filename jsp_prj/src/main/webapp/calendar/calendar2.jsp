...
//오늘의 요일을 표현하기 위해서 오늘 정보를 저장한 후 비교 한다.
...
//log(String.valueOf(toString().equals(selectDay.toString())));
...
<tbody>
<tr>
<%! //declaration : 선언 - JSP에서 method를 만들거나, instance 변수, static 변수를 선언할 때
//사용
